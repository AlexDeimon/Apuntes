import{d as g,r as b,h,c,b as e,e as n,f as o,a as t,j as d,t as w,g as v,w as x,o as p,_ as k}from"./index-Cl7SRf-B.js";import{C as l}from"./CodeBlock-2kVtg3uu.js";import{R as y}from"./ReferenceSection-DOgwaU6M.js";const C={class:"module-content"},E={class:"topic-section"},S={class:"cards-grid"},z={class:"card recommended"},D={class:"preview-container"},F={class:"preview-content"},R={class:"btn-toggle-group"},q={class:"demo-note"},B={class:"topic-section"},L={class:"cards-grid"},P={class:"card info"},j={class:"preview-container"},I={class:"preview-content"},N={class:"btn-toggle-group"},V={class:"input-demo-area"},M={key:0,class:"input-demo-group"},O={key:1,class:"input-demo-group"},T={key:2,class:"input-demo-group"},$={key:3,class:"input-demo-group"},A={class:"topic-section"},U={class:"cards-grid"},G={class:"card info"},H={class:"topic-section"},W={class:"cards-grid"},J={class:"card info"},X={class:"preview-container"},K={class:"preview-content"},Q={class:"btn-toggle-group"},Y={class:"select-demo-wrap"},Z={key:0,class:"select-native"},_={key:1,class:"select-custom-wrap"},ee={class:"topic-section"},ae={class:"cards-grid"},oe={class:"card info"},se={class:"topic-section"},ne={class:"card info"},te={class:"preview-container preview-wide"},de={class:"preview-content"},le={class:"topic-section"},ie={class:"cards-grid"},re={class:"card info"},ce=`select {
