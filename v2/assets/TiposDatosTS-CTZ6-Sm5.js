import{C as o}from"./CodeBlock-DbAkMvLy.js";import{R as t}from"./ReferenceSection-BG8J8qOZ.js";import{d as r,c as a,a as l,b as n,e as s,f as i,o as d}from"./index-B8X3dxf3.js";const p={class:"module-content"},u={class:"topic-section"},c={class:"cards-grid"},m={class:"card info"},g={class:"card info"},v={class:"topic-section"},f={class:"cards-grid"},y={class:"card warning"},b={class:"card recommended"},T={class:"card info"},S={class:"topic-section"},E={class:"cards-grid"},q={class:"card info"},A={class:"card info"},D={class:"card info"},j={class:"card info"},C={class:"card info"},P={class:"card info"},w={class:"card info"},x={class:"topic-section"},L={class:"cards-grid"},N={class:"card info"},k={class:"card info"},V=r({__name:"TiposDatosTS",setup(B){return(z,e)=>(d(),a("div",p,[e[33]||(e[33]=l('<div class="header-section"><h1 class="main-title typescript">Tipos de Datos</h1><p class="subtitle">La base de la seguridad y el tipado estático en TypeScript.</p></div><section class="topic-section"><h2 class="section-title typescript">Tipado Estático</h2><p class="section-desc">A diferencia de JavaScript, que es de tipado dinámico, TypeScript permite definir tipos de forma estática. Esto significa que podemos especificar qué tipo de datos debe contener una variable, permitiendo detectar errores durante el desarrollo y no en tiempo de ejecución.</p></section>',2)),n("section",u,[e[4]||(e[4]=n("h2",{class:"section-title typescript"},"Tipos Primitivos",-1)),e[5]||(e[5]=n("p",{class:"section-desc"},"TypeScript soporta todos los tipos primitivos de JavaScript.",-1)),n("div",c,[n("div",m,[e[0]||(e[0]=n("h3",null,"string, number, boolean",-1)),e[1]||(e[1]=n("p",null,"Los tipos básicos para texto, números (incluyendo decimales) y valores lógicos.",-1)),s(o,{language:"typescript",code:`let nombre: string = "Diego";
let edad: number = 25;
...
let persona1: Persona = {
  nombre: "Ana",
  edad: 28,
};`})]),n("div",D,[e[17]||(e[17]=n("h3",null,"Objetos",-1)),e[18]||(e[18]=n("p",null,"Se definen mediante el nombre del objeto seguido de llaves {}.",-1)),s(o,{language:"typescript",code:`let persona: {
  nombre: string;
  edad: number
}
...
let persona1: persona = {
  nombre: "Luis",
  edad: 22,
};`})]),n("div",j,[e[19]||(e[19]=n("h3",null,"Arrays",-1)),e[20]||(e[20]=n("p",null,"Se definen mediante el nombre del array seguido de corchetes [].",-1)),s(o,{language:"typescript",code:`let lista: number[] = [1, 2, 3];
...
let miDireccion: Direccion = Direccion.Arriba;`})]),n("div",P,[e[23]||(e[23]=n("h3",null,"Tuplas",-1)),e[24]||(e[24]=n("p",null,"Permiten expresar un array con un número fijo de elementos cuyos tipos son conocidos.",-1)),s(o,{language:"typescript",code:`let persona: [string, number];
persona = ["Diego", 25];
// persona = [25, "Diego"]; // Error!`})]),n("div",w,[e[25]||(e[25]=n("h3",null,"Union Types",-1)),e[26]||(e[26]=n("p",null,"Permiten que una variable pueda ser de más de un tipo.",-1)),s(o,{language:"typescript",code:`let id: string | number;
id = 10;
id = "ABC";`})])])]),e[34]||(e[34]=n("hr",{class:"divider"},null,-1)),n("section",x,[e[32]||(e[32]=n("h2",{class:"section-title typescript"},"Aserciones y Narrowing",-1)),n("div",L,[n("div",N,[e[28]||(e[28]=n("h3",null,"Type Assertions (as)",-1)),e[29]||(e[29]=n("p",null,'Cuando tú sabes más sobre el tipo de un valor que TypeScript, puedes "forzar" el tipo.',-1)),s(o,{language:"typescript",code:`// canvas es un HTMLElement por defecto
const canvas = document.getElementById("main") as HTMLCanvasElement;

// Tambien se puede usar: <HTMLCanvasElement>canvas`})]),n("div",k,[e[30]||(e[30]=n("h3",null,"Narrowing",-1)),e[31]||(e[31]=n("p",null,"Técnica para reducir un tipo amplio a uno más específico mediante validaciones.",-1)),s(o,{language:"typescript",code:`function split(val: string | number) {
  if (typeof val === "string") {
    return val.split(""); // TS sabe que es string
  }
  return val.toFixed(2); // TS sabe que es number
}`})])])]),s(t,{references:[{techId:"js",moduleId:"fundamentos",text:"Fundamentos de JavaScript"}]})]))}});export{V as default};
