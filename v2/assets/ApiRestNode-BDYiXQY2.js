import{d as g,r as S,y as v,c,a as k,b as t,e as f,l as m,h as b,v as R,j as T,f as I,i as q,t as l,F as y,k as C,o as u,_ as L}from"./index-CaUrYX4U.js";import{C as O}from"./CodeBlock-B-SpWwSA.js";import{R as N}from"./ReferenceSection-1V-ePbHK.js";const j={class:"module-content"},D={class:"topic-section"},U={class:"simulator-container"},A={class:"sim-client-panel"},M={class:"sim-row"},B={class:"sim-group method-group"},z={class:"sim-group url-group"},w={class:"url-input-wrapper"},G=["disabled"],F={key:0,class:"sim-group body-group"},_={key:0,class:"sim-server-panel"},H={class:"sim-response-header"},J={class:"sim-response-body"},V={class:"response-json"},K={class:"store-preview"},$={class:"books-badges"},Q={class:"book-id"},W={class:"book-title"},X={class:"book-author"},Y={class:"topic-section"},Z={class:"card recommended"},aa=g({__name:"ApiRestNode",setup(ea){const i=S([{id:1,title:"El Quijote",author:"Miguel de Cervantes"},{id:2,title:"Cien años de soledad",author:"Gabriel García Márquez"},{id:3,title:"Don Quijote II",author:"Miguel de Cervantes"}]),s=v({method:"GET",idParam:"",body:""}),e=v({status:0,statusText:"",data:null}),h=()=>{s.method==="POST"?(s.idParam="",s.body=`{
  "title": "Nuevo Libro",
