import{C as o}from"./CodeBlock-DbAkMvLy.js";import{R as i}from"./ReferenceSection-BG8J8qOZ.js";import{d as a,c as r,b as e,e as n,f as t,o as l}from"./index-B8X3dxf3.js";const d={class:"module-content"},c={class:"topic-section"},u={class:"card info"},p={class:"topic-section"},m={class:"cards-grid"},g={class:"card info"},v={class:"card info"},y={class:"topic-section"},f={class:"topic-section"},E={class:"card recommended"},x=a({__name:"EnumsTS",setup(S){return(b,s)=>(l(),r("div",d,[s[14]||(s[14]=e("div",{class:"header-section"},[e("h1",{class:"main-title typescript"},"Enums"),e("p",{class:"subtitle"},"Definiendo conjuntos de constantes con nombre para un código más legible y seguro.")],-1)),e("section",c,[s[1]||(s[1]=e("h2",{class:"section-title typescript"},"¿Qué son los Enums?",-1)),s[2]||(s[2]=e("p",{class:"section-desc"},[t("Los "),e("strong",null,"enum"),t(" son un tipo de dato en TypeScript. Esta característica no es una extensión de JavaScript, sino una peculiaridad propia de TypeScript. Se encargan de juntar en un solo tipo de dato un conjunto finito de constantes.")],-1)),s[3]||(s[3]=e("p",{class:"section-desc"},"Similar a un Array, al definir un enum, cada constante se le asigna por defecto un índice desde 0 y se incrementa automáticamente para el resto de las constantes.",-1)),e("div",u,[s[0]||(s[0]=e("div",{class:"card-header"},[e("h3",null,"Sintaxis Básica")],-1)),n(o,{language:"typescript",code:`enum Direccion {
  Norte,
  Sur,
  Este,
  Oeste
