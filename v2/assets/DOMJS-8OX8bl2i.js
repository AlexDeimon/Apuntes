import{C as o}from"./CodeBlock-B-SpWwSA.js";import{R as k}from"./ReferenceSection-1V-ePbHK.js";import{d as H,r as b,c,a as l,b as a,e as s,f as t,n as T,i as q,t as f,F as M,k as x,l as O,p as A,o as m,_ as N}from"./index-CaUrYX4U.js";const z={class:"module-content"},B={class:"topic-section"},P={class:"cards-grid"},R={class:"topic-section"},w={class:"cards-grid"},V={class:"card info"},F={class:"card recommended"},J={class:"topic-section"},$={class:"cards-grid"},U={class:"cards-grid"},X={class:"card recommended"},Q={class:"topic-section"},G={class:"cards-grid"},K={class:"topic-section"},W={class:"cards-grid"},Y={class:"topic-section"},Z={class:"cards-grid"},_={class:"card info"},ee={class:"card recommended"},ae={class:"cards-grid"},te={class:"card info"},ne={class:"card recommended"},se={class:"topic-section"},oe={class:"sandbox-container"},le={class:"sandbox-preview"},de={class:"sandbox-title"},ie={class:"sandbox-list"},re=["onClick"],be={class:"sandbox-terminal"},ce={class:"code-text"},me={key:0,class:"terminal-placeholder"},ue=H({__name:"DOMJS",setup(ve){const g=b("Mi Sandbox del DOM"),p=b(!1),C=b("rgba(255, 255, 255, 0.02)"),r=b([{id:1,text:"Item Original #1"},{id:2,text:"Item Original #2"}]),u=b([]),v=b(null),d=n=>{u.value.push(n),A(()=>{v.value&&(v.value.scrollTop=v.value.scrollHeight)})},E=()=>{u.value=[]},y=()=>{const n=["¡DOM Cambiado!","Aprendiendo DOM","JavaScript es genial","Modificación exitosa"],e=n[Math.floor(Math.random()*n.length)];g.value=e,d(`const title = document.querySelector('.sandbox-title');
