import{C as s}from"./CodeBlock-DiIRJ6lH.js";import{d as o,c as i,b as e,e as n,f as l,a as r,o as d}from"./index-Bn5NyT--.js";const t={class:"module-content"},c={class:"topic-section"},u={class:"cards-grid"},p={class:"card recommended"},m={class:"card warning"},v={class:"topic-section"},g={class:"cards-grid"},b={class:"card"},f={class:"card"},j={class:"topic-section"},y={class:"cards-grid"},S={class:"card"},q={class:"card recommended"},C={class:"card warning"},E={class:"cards-grid"},J={class:"card"},L={class:"card"},N={class:"topic-section"},x={class:"cards-grid"},D={class:"card"},z={class:"topic-section"},A={class:"cards-grid"},O={class:"card"},T={class:"card"},V={class:"card"},B={class:"card"},H={class:"card"},R=o({__name:"FundamentosJS",setup(M){return(F,a)=>(d(),i("div",t,[a[45]||(a[45]=e("div",{class:"header-section"},[e("h1",{class:"main-title js"},"Fundamentos JavaScript"),e("p",{class:"subtitle"},"La base de la interactividad en la web")],-1)),e("section",c,[a[4]||(a[4]=e("h2",{class:"section-title"},"Conectar HTML y JavaScript",-1)),a[5]||(a[5]=e("p",{class:"section-desc"}," Existen principalmente dos formas de vincular JavaScript a un documento HTML. La ubicación del script es crucial para el rendimiento de carga.",-1)),e("div",u,[e("div",p,[a[0]||(a[0]=e("div",{class:"card-header"},[e("h3",null,"Script Externo"),e("span",{class:"badge success"},"Recomendado")],-1)),a[1]||(a[1]=e("p",null,[l("Se vincula un archivo "),e("code",null,".js"),l(" separado. Es la mejor práctica para mantener el código organizado y reutilizable. Se recomienda ubicarlo al final del "),e("code",null,"<body>"),l(" para no bloquear la carga visual.")],-1)),n(s,{language:"html",code:`<body>
