import{C as a}from"./CodeBlock-BRMidGAh.js";import{R as d}from"./ReferenceSection-Cze-_fSr.js";import{d as i,c as t,b as e,e as n,f as r,a as o,o as l}from"./index-DAfjV5Gp.js";const u={class:"module-content"},p={class:"topic-section"},c={class:"card recommended"},m={class:"topic-section"},v={class:"cards-grid"},g={class:"card info"},x={class:"card info"},j={class:"topic-section"},q={class:"cards-grid"},f={class:"card info"},P={class:"card recommended"},E={class:"topic-section"},R={class:"cards-grid"},b={class:"card info"},T={class:"card recommended"},y={class:"card recommended"},S={class:"topic-section"},w={class:"card recommended"},h=i({__name:"ExpressNode",setup(I){return(M,s)=>(l(),t("div",u,[s[22]||(s[22]=e("div",{class:"header-section"},[e("h1",{class:"main-title node"},"Express.js"),e("p",{class:"subtitle"},"El framework web rápido, minimalista y flexible para Node.js.")],-1)),e("section",p,[s[1]||(s[1]=e("h2",{class:"section-title node"},"¿Qué es Express?",-1)),s[2]||(s[2]=e("p",{class:"section-desc"},[r("Express abstrae la complejidad del módulo "),e("code",null,"http"),r(" nativo de Node.js, ofreciendo una sintaxis mucho más limpia para crear servidores, manejar rutas y trabajar con peticiones/respuestas.")],-1)),e("div",c,[s[0]||(s[0]=e("div",{class:"card-header"},[e("h3",null,"Crear un Servidor Básico")],-1)),n(a,{language:"javascript",code:`const express = require('express');
const app = express();
const PORT = 3000;
