import{C as o}from"./CodeBlock-BGyVVXcz.js";import{d as l,c as a,a as i,b as n,e as t,f as e,o as r}from"./index-CA2D9pAo.js";const d={class:"module-content"},c={class:"topic-section"},u={class:"cards-grid"},p={class:"card info"},g={class:"card recommended"},v={class:"topic-section"},m={class:"card info"},f={class:"topic-section"},S={class:"cards-grid"},j={class:"card"},b={class:"card"},H={class:"card"},x={class:"card"},C={class:"card"},M={class:"card"},J={class:"card"},y={class:"card"},E=l({__name:"StringsJS",setup(q){return(z,s)=>(r(),a("div",d,[s[26]||(s[26]=i('<div class="header-section"><h1 class="main-title js">Strings</h1><p class="subtitle">Manipulación y propiedades de cadenas de texto</p></div><section class="topic-section"><h2 class="section-title js">Introducción</h2><p class="section-desc">Un <strong>String</strong> (cadena de caracteres) es una secuencia de caracteres usada para representar texto. En JavaScript, los strings son inmutables, lo que significa que una vez creados, no pueden ser modificados. Los métodos que &quot;modifican&quot; un string en realidad devuelven uno nuevo.</p></section>',2)),n("section",c,[s[4]||(s[4]=n("h2",{class:"section-title js"},"Creación de Strings",-1)),n("div",u,[n("div",p,[s[0]||(s[0]=n("h3",null,"Comillas Simples y Dobles",-1)),s[1]||(s[1]=n("p",null,"Son funcionalmente idénticas en JS.",-1)),t(o,{language:"javascript",code:`const str1 = 'Hola Mundo';
