import{d as g,r as S,y as m,c,a as k,b as t,e as b,g as T,i as p,v as R,k as f,f as I,j as q,t as l,F as y,l as C,o as u,_ as L}from"./index-CbnFgOaN.js";import{C as O}from"./CodeBlock-Da25pLxT.js";import{R as N}from"./ReferenceSection-BK_PKAW_.js";const j={class:"module-content"},D={class:"topic-section"},U={class:"simulator-container"},A={class:"sim-client-panel"},M={class:"sim-row"},B={class:"sim-group method-group"},z={class:"sim-group url-group"},w={class:"url-input-wrapper"},G=["disabled"],F={key:0,class:"sim-group body-group"},_={key:0,class:"sim-server-panel"},H={class:"sim-response-header"},J={class:"sim-response-body"},V={class:"response-json"},K={class:"store-preview"},$={class:"books-badges"},Q={class:"book-id"},W={class:"book-title"},X={class:"book-author"},Y={class:"topic-section"},Z={class:"card recommended"},aa=g({__name:"ApiRestNode",setup(ea){const i=S([{id:1,title:"El Quijote",author:"Miguel de Cervantes"},{id:2,title:"Cien años de soledad",author:"Gabriel García Márquez"},{id:3,title:"Don Quijote II",author:"Miguel de Cervantes"}]),s=m({method:"GET",idParam:"",body:""}),e=m({status:0,statusText:"",data:null}),h=()=>{s.method==="POST"?(s.idParam="",s.body=`{
  "title": "Nuevo Libro",
