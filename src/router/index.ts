...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/js/objetosNativos',
      name: 'js-objetosNativos',
    ...
    {
      path: '/typescript/tiposavanzados',
      name: 'typescript-tiposavanzados',
      component: () => import('@/views/TypeScript/TiposAvanzadosTS.vue'),
    },
    {
      path: '/nodejs/inicio',
      name: 'nodejs-inicio',
