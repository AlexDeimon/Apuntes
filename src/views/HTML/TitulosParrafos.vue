  ...
  <div class="module-content">
    ...
    <section class="topic-section">
      ...
      <p class="section-desc">HTML ofrece 6 niveles de títulos, desde <code>&lt;h1&gt;</code> hasta
        <code>&lt;h6&gt;</code>. Son fundamentales para la jerarquía del documento y el SEO.</p>
...
<h6>Título nivel 6</h6>' />
    ...
    <section class="topic-section">
      ...
      <p class="section-desc">La etiqueta <code>&lt;p&gt;</code> define un párrafo. Los navegadores añaden
        automáticamente un margen antes y después de cada párrafo. Son elementos de bloque, lo que significa que siempre
        empiezan en una nueva línea y ocupan todo el ancho disponible.</p>
...
h4 {
  ...
  margin-top: 1.5rem;
    ...
    <ReferenceSection :references="[
      { techId: 'css', moduleId: 'fundamentos', text: 'Fundamentos de CSS' }
    ]" />
  </div>
</template>
